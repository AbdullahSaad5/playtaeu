...
@section('content')
    <section class="section add-payment">
        <div class="add-payment-card">
            ...
            @if (Request::is() === '/addPaymentCard')
                <form action='/addPaymentCard' method="POST">
                @else
                    <form action='/update-card/id={{ $data->card_id }}' method="POST">
            @endif
            @csrf
            <div class="card-info">
                ...
                <div class="card-numbers">
                    ...
                    <div class="security-code">
                        ...
                        <input type="text" name="security-code" value="{{ $data ? $data->security_code : '' }}" required>
                    </div>
                </div>
                <div class="expiration-date">
                    <label for="">Expiration date</label>
                    <input type="month" name="expiration-date" value="{{ $data ? $data->expiration_date : '2022-01' }}"
                        required>
                </div>
